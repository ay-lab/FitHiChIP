...
if TARGETRES not in resolution_values:
	print("\n\n ERROR !!!! Processing input .hic file -- \n Input .hic file contains resolutions: + ", str(resolution_values) + "\n Target resolution : " + str(TARGETRES) + "\n Target resolution is not contained in the input .hic file - quit")
	sys.exit()
	...
	for chrom in chromlist:
		if chrom.name != "All":
			...
			for i in range(len(result)):
				## format: chr, start1, end1, chr2, start2, end2, cc
